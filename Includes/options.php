...
$extensions=$this->setextensions();
    ...
    public function check_ID( $input ) { //validation and sanitizing here, then we update the DB
            ...
            if ($input["Administrator_can_create_gal"]!="checked") {
            $input["Administrator_can_create_gal"] = "checked";    
            }
            }  
            ...
            if ($input['unlogged_users_can_upload']=="checked") {
...
<?php } ?>
<div class="options_box" style="margin-top:20px;">
<span class="options_box_header">

<input type="checkbox" name="NGG_User_upload_option_array[<?php echo "unlogged_users_can_upload"?>]" value="<?php echo $options['unlogged_users_can_upload'];?>" <?php echo $options['unlogged_users_can_upload'];?>/>
Enable users who aren't logged in to upload.
</span>

Please note, enabling this option will allow un-logged in users to upload files to your site. It should be noted that while every step is taken to ensure
that this plugin is secure, you are basically allowing ANYONE to upload whatever pictures they want. The ownice will on YOU to take altenate steps to filter
or moderate who can upload pictures, such as adding password protection, or other means.  
<br>
<br>
<span style="color:#ff0000">
By enabling this option, you agree that I, the author of this plugin, will not be held responsible if users upload illicit images, including but not limited to
pornography, or any other offensive or illict material. Furthermore, you agree that you are solely responsible for ensuring you take proper steps to moderate
